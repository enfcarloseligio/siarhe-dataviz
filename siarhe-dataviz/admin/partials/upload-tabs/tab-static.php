...
<div class="card" style="max-width: 100%; padding: 0; overflow: hidden;">
    ...
    <div class="siarhe-toolbar">
        ...
        <div class="siarhe-search-box">
            ...
            <input type="text" id="siarhe-search-static" placeholder="Buscar entidad, archivo o estado...">
        </div>
    </div>
    ...
    <table id="siarhe-static-table" class="siarhe-table">
        ...
        <tbody id="siarhe-static-tbody">
            ...
            foreach ($entidades_data as $slug => $data) {
                ...
                $ruta_fisica = $archivo ? $upload_base_dir . ltrim($archivo->ruta_archivo, '/') : '';
            ...
            <?php endforeach; ?>
            <tr id="siarhe-static-empty" style="display: none;">
    ...
    <div class="siarhe-pagination">
        <div id="siarhe-static-count" style="font-size: 13px; color: #64748b;"></div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const emptyRow = document.getElementById('siarhe-static-empty');
    ...
    // Lógica interna para acordeón móvil
